    ...
    <>
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-[0.025]" style={{ backgroundImage: "radial-gradient(circle, #1B3A2D 0.8px, transparent 0.8px)", backgroundSize: "20px 20px" }} />
          <div className="absolute top-0 right-0 w-[700px] h-[700px] bg-green-light/50 rounded-full blur-[140px]" />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-light/30 rounded-full blur-[120px]" />
        </div>
