          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
            ...
            <div className="space-y-10 lg:sticky lg:top-28">
              ...
              <div className="space-y-4">
                ...
                <FadeIn delay={0.5}>
                  <a href="https://www.linkedin.com/company/yumnisas" target="_blank" rel="noopener noreferrer" onClick={() => track("contact_linkedin_click")} className="group flex items-center gap-4 p-5 rounded-xl border border-line bg-white hover:border-green/20 hover:shadow-[0_4px_16px_rgba(0,129,74,0.06)] transition-all duration-300">
                    <div className="w-12 h-12 shrink-0 rounded-xl bg-green-light/50 flex items-center justify-center group-hover:bg-green-light transition-colors">
