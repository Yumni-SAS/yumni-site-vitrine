    ...
    <>
      ...
      <section className="relative pt-32 pb-8 md:pt-44 md:pb-16 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 opacity-[0.035]" style={{ backgroundImage: "linear-gradient(#1B3A2D 1px, transparent 1px), linear-gradient(to right, #1B3A2D 1px, transparent 1px)", backgroundSize: "48px 48px" }} />
          ...
          <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-green-light/40 rounded-full blur-[140px]" />
          <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-orange-light/25 rounded-full blur-[120px]" />
        </div>
